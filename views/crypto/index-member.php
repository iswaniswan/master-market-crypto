...
//                        ],
                        ...
                        'header' => 'Market Jual',
                        'value' => function ($model) {
                            if (intval($model->harga) > 0) {
                                return "USDT " . number_format($model->harga_jual, 2, ".", ",");
                            }
                            return "-";
                        },
                        'headerOptions' => ['style' => 'text-align:left;'],
                    ...
                    [
                        ...
                        'value' => function ($model) {
                            if (intval($model->harga) > 0) {
                                return "USDT " . number_format($model->harga_beli, 2, ".", ",");
                            }
                            return "-";
                        },
                        'headerOptions' => ['style' => 'text-align:left;'],
                    ...
                    'buttons' => [
                        'view' => function ($url, $model) {
                            if (intval($model->harga) > 0) {
                                return Html::a('Detail', ['swap', 'id' => @$model->id], ['title' => 'Detail', 'data-pjax' => '0', 'class' => 'btn btn-info btn-sm']);
                            }
                            return "-";
                        },
