...
<div class="row mb-4">
    <div class="container-fluid">
        <div class="dt-button-wrapper">
            <?= Html::a('<i class="ti-reload mr-2"></i> Update Coincap', ['update-coincap'], ['class' => 'btn btn-purple mb-1']) ?>
...
//                        ],
                        ...
                        'value' => function ($model) {
                            $html = <<<HTML
                                <a href="{$model->explorer}" target="_blank" class="btn btn-info btn-sm">Sumber</a>
                            HTML;
